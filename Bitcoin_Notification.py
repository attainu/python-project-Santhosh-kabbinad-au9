...
IFTTT_URL = 'https://maker.ifttt.com/trigger/{}/with/key/dfieaZ1TUcFZg36gXIBpPS'
...
def main(interval, upper_threshold):
    ...
    while True:
        ...
        if 10000 < price < 11000:
            notification('btc_twitter', price)
